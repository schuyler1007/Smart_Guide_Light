...
//  Serial.println(LEDset_1);
    ...
    if (!strcmp(walking_direction, "RightToLeft")) {
        ...
        if (start_point_clarification_count_1 >
            3) { // EXECUTING EVERYTHING HERE AFTER CLARIFYING PERSON LOCATION, expecting 3 readings that are in the range of the expected starting point
            ...
            if (S1_first_time_1 ==
                true) { // Checking if the 86th index  and if so send orange flash lights if the person walked the area in more than 20 seconds
                int check_it = 0;
                for (int i = 0; i < 20; i++) {
            ...
            if (S3_first_time_1 ==
                ...
                for (int i = 0; i < 20; i++) {
                    ...
                    if (LEDset_1[i] == 1)
                        check_it = 1;  // margin of +- 10 in case the walker moves too fast, reason for having 33+i rather than 43+i
            ...
            // might need to be greater than rather than less than 
...

    {
        ...
        if (start_point_clarification_count_2 >
            3) { // EXECUTING EVERYTHING HERE AFTER CLARIFYING PERSON LOCATION, expecting 3 readings that are in the range of the expected starting point
            ...
            if (start_point_clarification_count_1 < 3) {// PERSON LOCATION CLARIFIED, EXECUTING THE LIGHT COMMANDS
                ...
                if (S1_first_time_1 ==
                    ...
                    for (int i = 0; i < 20; i++) {
                        ...
                        if (LEDset_1[76 + i] == 1)
                            check_it = 1;  // margin of +- 10 in case the walker moves too fast, reason for having 76+i rather than 86+i
